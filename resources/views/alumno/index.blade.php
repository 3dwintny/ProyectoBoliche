    ...
    <tr>
      ...
      <form action="" method="POST">
       <a class="btn btn-sm btn-primary " href="{{ route('alumnos.show',$alumno->id) }}"><i class="fa fa-fw fa-eye"></i>Ver</a>
        <a class="btn btn-sm btn-success" href="{{ route('alumnos.create')}}"><i class="fa fa-fw fa-edit"></i>Aceptar</a>
        <a class="btn btn-sm btn-danger" href="{{ route('alumnos.create')}}"><i class="fa fa-fw fa-edit"></i>Rechazar</a>
      </form>
      </td>
    </tr>
    @endforeach
