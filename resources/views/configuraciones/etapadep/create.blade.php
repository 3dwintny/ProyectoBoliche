            ...
            <div class="col-lg-8 col-md-8">
                <div class="card">
                    <div class="card-header text-bold ">
                        <strong>
                            <h2>Registrar Nueva Etapa Deportiva</h2>
                        </strong>
                    ...
                    @endif
                <form method="post" role="form" enctype="multipart/form-data" action="{{route('etapa-deportiva.store')}}">
                    @csrf
                        ...
                        <div class="card-body bg-light">
                            <div class="form-group{{ $errors->has('nombre') ? ' has-danger' : '' }}">
                                <div class="form-floating mb-3">
                                    <input class="form-control {{ $errors->has('nombre') ? ' is-invalid' : '' }} text-dark" aria-describedby="basic-addon2" placeholder="{{ __('Etapa') }}" id="nombre" type="text" name="nombre" value="{{ old('nombre') }}" required>
