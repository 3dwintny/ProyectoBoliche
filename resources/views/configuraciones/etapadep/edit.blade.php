                ...
                <div class="card">
                    <div class="card-header text-bold ">
                        <strong>
                            <h2>
                                Editar
                                <a href="{{ url('etapa-deportiva') }}" class="btn btn-danger btn-sm float-right">Regresar</a>
                            </h2>
                        </strong>
                    </div>
                    @if(session('error'))
                    ...
                    @endif
                    <form method="post" role="form" enctype="multipart/form-data" action="{{route('etapa-deportiva.update',encrypt($etapa->id))}}">
                        @csrf
                        {{method_field('PUT')}}
                        <div class="card">
