                ...
                <div class="card">
                    <div class="card-header text-bold ">
                        <strong>
                            <h2>
                                Editar
                                <a href="{{ url('municipio') }}" class="btn btn-danger btn-sm float-right">Regresar</a>
                            </h2>
                        </strong>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body bg-light">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="nombre" placeholder="Municipio" name="nombre" value="{{$municipio->nombre}}" required>
