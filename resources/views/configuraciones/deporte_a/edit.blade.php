        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-6 col-md-10 col-sm-8">
                <div class="card">
                    ...
                    @endif
                    <form method="post" role="form" enctype="multipart/form-data" action="{{route('deporte-adaptado.update',encrypt($deporte->id))}}">
                        @csrf
                        {{method_field('PUT')}}
                        <div class="card">
                            <div class="card-body bg-light">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="nombre" placeholder="Deporte adaptado" name="nombre" value="{{$deporte->nombre}}" required>
