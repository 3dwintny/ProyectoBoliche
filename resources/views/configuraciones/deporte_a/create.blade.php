            ...
            <div class="col-lg-8 col-md-8">
                <div class="card">
                    <div class="card-header text-bold ">
                        <strong>
                            <h2> Registrar Nuevo Deporte Adaptado </h2>
                        </strong>

                    </div>
                <form method="post" role="form" enctype="multipart/form-data" action="{{route('deportes-adoptados.store')}}">
                    @csrf
                    ...
                    <div class="card">
                        <div class="card-body bg-light">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="descripcion" placeholder="Deporte Adaptado" name="nombre" required>
                                <label for="nombre">Deportes Adaptados</label>
                            </div>
                            <div class="container">
