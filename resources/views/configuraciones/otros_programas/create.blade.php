                        ...
                        <div class="card-body bg-light">
                            <div class="form-group{{ $errors->has('nombre') ? ' has-danger' : '' }}">
                                <div class="form-floating mb-3">
                                    <input class="form-control {{ $errors->has('nombre') ? ' is-invalid' : '' }} text-dark" aria-describedby="basic-addon2" placeholder="{{ __('Programa de atención') }}" id="nombre" type="text" name="nombre" value="{{ old('nombre') }}" required>
