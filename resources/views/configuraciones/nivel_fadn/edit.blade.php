                ...
                <div class="card">
                    <div class="card-header text-bold ">
                        <strong>
                            <h2>
                                Editar
                                <a href="{{ url('nivel-fadn') }}" class="btn btn-danger btn-sm float-right">Regresar</a>
                            </h2>
                        </strong>
                    </div>
                    <form method="post" role="form" enctype="multipart/form-data" action="{{route('nivel-fadn.update',encrypt($nivel->id))}}">
                        @csrf
                        {{method_field('PUT')}}
                        <div class="card">
