        ...
        <div class="header-body">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <h1 class="text-white">Designar práctica en casa</h1>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid pt-2">
    <div class="header-body text-center mb-7">
        <div class="row justify-content-center">
            ...
            @endif
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <form method="POST" action="{{route('entreno-en-casa.store')}}" enctype="multipart/form-data" role="form">
                    @csrf
                    <input type="hidden" name="entrenador_id" id="entrenador_id" value="{{encrypt($entrenador[0]->id)}}" required>
