                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 mb-2">
                                        <div class="input-group mb-2">
                                            ...
                                            <input class="form-control text-dark" type="text" name="edad" aria-label="edad" id="_edad" value="{{$atleta->edad}}" aria-describedby="basic-addon1" style="text-align: center;" readonly>
                                        </div>
                                    </div>
